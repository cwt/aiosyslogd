...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **001** | CSRF Protection Bypass via Content-Type Filtering | Python / Middleware | High | Confirmed | [001.md](./001.md) |
| **002** | Open Redirect Vulnerability on Login Endpoint | Python / Auth | High | Confirmed | [002.md](./002.md) |
| **003** | Arbitrary Database File Access in /api/activity | Python / API | High | Confirmed | [003.md](./003.md) |
...
| **008** | Uncaught Null Reference Crash on Profile Page when Gemini is Disabled | JavaScript / Profile | Medium | Confirmed | [008.md](./008.md) |
| **009** | Regex Substring False Positives and Missing Word Boundaries in Dynamic Highlighter | JavaScript / Highlighter | Medium | Confirmed | [009.md](./009.md) |
